# [Example 1.1] 분포와 관련된 네 가지 R 함수

# 확률 계산
pnorm(0) ; pnorm(1) ; pnorm(1.96) ; pnorm(-1) ; pnorm(1.96)-pnorm(-1.96)

# 분위수 계산
qnorm(0.95) ; qnorm(0.975)

# 상위 분위수 계산
qnorm(0.05, lower.tail=FALSE) ; qnorm(0.025, lower.tail=FALSE)

# 표준정규분포 확률밀도함수 값 계산(z=0)
dnorm(0)

# [Example 1.2] 정규분포 확률 계산

# (1) 표준화를 이용한 확률 계산
1 - pnorm( (175-170)/6 ) ; pnorm( (180-170)/6 ) - pnorm( (175-170)/6 )
help(pnorm) # pnorm()의 도움말 보기
